        ...
        {projects.map((proj) => (
          <StaggerItem key={proj.name}>
            <motion.div
              ...
              className="h-full rounded-2xl glass-card p-7 transition-colors hover:border-accent/40"
            >
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent/15 text-accent-light">
                  <FiFolder size={18} />
                </span>

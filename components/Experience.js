              ...
              >
                ...
                >
                  <div className="rounded-2xl glass-card p-6 transition-colors hover:border-accent/40">
                    ...
                    <p className="text-sm font-medium text-white/70">{job.company}</p>
                    <p
                      className={`mt-1 flex items-center gap-1.5 text-xs text-white/40 ${
                    ...
                    <ul
                      className={`mt-4 space-y-2 text-sm leading-relaxed text-white/55 ${
